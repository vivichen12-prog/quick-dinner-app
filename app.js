...
const INGREDIENT_SEMANTIC_GROUPS = [
  { keywords: ["豬", "豬肉", "豬肉片", "豬肉碎", "豬絞肉", "豬里肌", "豬梅花"] },
  { keywords: ["牛", "牛肉", "牛肉片", "牛五花", "牛絞肉"] },
  { keywords: ["雞", "雞肉", "雞腿", "雞胸", "雞胸肉", "雞翅", "去骨雞腿"] },
  { keywords: ["魚", "鱸魚", "鯛魚", "鮭魚", "魚排", "魚片", "金目鱸"] },
  { keywords: ["海鮮", "冷凍海鮮包", "蝦仁", "花枝", "魷魚", "蛤蜊", "綜合海鮮"] },
